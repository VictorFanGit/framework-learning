...
public class DemoApp {
    ...
    private static final String TOPIC1 = "video-stream";
    private static final String TOPIC2 = "radar-stream";
...
/*        Jedis jedis = null;
        ...
        RegisterService registerService = new RegisterService(TOPIC1);
        ...
        while (true) {
            try {
                ...
                Thread.sleep(rad);
                String task = generateInstanceId(TOPIC1);
