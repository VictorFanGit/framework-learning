...
public class RestTemplateConfig {
    ...
    public CustomHttpComponentsClientHttpRequestFactory clientHttpRequestFactory() {
        ...
        try {
            ...
            LOGGER.warn("Exception occurred when build ssl context: ", e);
            return null;
        }
        ...
        poolingHttpClientConnectionManager.setMaxTotal(2000); //最大连接数
        poolingHttpClientConnectionManager.setDefaultMaxPerRoute(100); //同路由并发数
